...
<section class="home-section">
  <div class="text">Ajouter des produits</div>
<body>
    <form action="produit.php" method="post" enctype="multipart/form-data">
        ...
        <input type="file" id="uploadInput" multiple accept="image/*" style="display: none;" name="image_path" required><br>
        <label for="uploadInput" class="btn">Choisir les images</label><br><br>
