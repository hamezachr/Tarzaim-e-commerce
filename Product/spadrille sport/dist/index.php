    ...
    <div class="etsy-app-interface">
        <div class="header">
            <div class="title-container">
                <h1><a href="../../../index/index.html">Tarzaim</a></h1>
                <a href="category.html" class="category-button">
                    <ion-icon name="menu-outline"></ion-icon>
                    Category
                </a>
            </div>
            <input type="text" class="search-bar" placeholder="Que cherchez-vous">
            <a href="../../../inscription/index.html" class="login-link">Se Connecter </a>
            <a href="#" class="icones"><ion-icon name="heart-outline"></ion-icon></a>
            <a href="#" class="icones"><ion-icon name="cart-outline"></ion-icon></ion-icon></a>
                            ...
                            <div class="small-12 large-6 columns">
                                <div class="productCard_leftSide clearfix">
                                    <div class="productCard_brendBlock">
                                        <a class="productCard_brendBlock__imageBlock" href="../../../index/index.html">
                                            <img src="LOGO.png" alt="Tarzaim">
                                        </a>
                                    </div>
                                    ...
                                    <div class="sliderBlock">
                                        <ul class="sliderBlock_items">
                                            ...
                                            <li class="sliderBlock_items__itemPhoto">
                                                <img src="4.png  alt="headphones">
                                            </li>
                                            <li class="sliderBlock_items__itemPhoto">
                                                <img src="3.png"  alt="headphones">
                                            </li>
    ...
    <div class="container">
      <div class="footer__columns">
        ...
        <div class="footer__copyrights">
          <p>Réalisé par <a href="../404/404.html" target="_blank">@Tarzaim</a></p>
        </div>
    </div>
  </footer>
