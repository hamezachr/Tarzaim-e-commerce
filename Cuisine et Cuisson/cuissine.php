...
<head>
    ...
    <title>Tarzaim</title>
    <link rel="stylesheet" href="cuissine.css">
...
<body>
    ...
    <div class="etsy-app-interface">
        ...
        <div class="results-container">
            ...
            <?php $vetementProducts = getProductsByCategory("Cuisine_et_Cuisson"); ?>

            <?php foreach ($vetementProducts as $product) { ?>
